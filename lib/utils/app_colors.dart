...
class AppColors{
  ...
  static Color primaryColor=const Color(0xFFE6E6E6);
  ...
  static Color textColors = const Color(0xFF033F4D);
  ...
  static Color shadowColor = const Color(0xFF545454);
  static Color backcolorsE6E6E6 = const Color(0xFFE6E6E6);
  static Color bottomBarColor = const Color(0xFFFF8400);
  static Color redColor = const Color(0xFFFF0000);
  static Color shadowRed = const Color(0xFFD80665);
